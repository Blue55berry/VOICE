...
const schemes = [
    { name: "Amma Unavagam", description: "Low-cost canteens providing affordable meals." },
    { name: "Amma Pharmacy", description: "Affordable medicines for the public." },
    ...
    { name: "Amma Baby Care Kit", description: "Free baby care kits for new mothers." },
